...
v2ray() {
  ...
  WireguardURL="wireguard://$(urlencode "$PrivateKey")@$Endip_v46?address=$(urlencode "$Address")&publickey=$(urlencode "$PublicKey")&mtu=$(urlencode "$MTU")#ÐΛɌ₭ᑎΞ𐒡𐒡_WireGuard"
...
echo -e "${blue}#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#${rest}"
echo -e "${blue}#+***********************************************+#${rest}"
echo -e "${blue}#+*              ${cyan} By --> ÐΛɌ₭ᑎΞ𐒡𐒡             ${blue} *+#${rest}"
echo -e "${blue}#+***********************************************+#${rest}"
echo -e "${blue}#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#${rest}"
echo ""
echo -e "${purple}*********************${rest}"
