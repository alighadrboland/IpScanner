...
[![](https://visitcount.itsvg.in/api?id=Mansor427&label=%20Views&color=6&icon=5&pretty=false)](https://https://github.com/mansor427/IpScanner/tree/main)
...
```
bash <(curl -fsSL https://raw.githubusercontent.com/mansor427/IpScanner/main/install.sh)
```
...
> [!CAUTION]
> ## عدد 4
> ## [4] با انتخاب گزینه ی 4 یک کانفیگ وایرگارد تولید شده که همراه با مقدار Reserved  است. و جهت استفاده در [V2rayNG](https://github.com/2dust/v2rayNG/releases) میباشد.
...
> ## بعد از دریافت کانفیگ رایگان و اضافه کردن آن در [V2rayNG](https://github.com/2dust/v2rayNG/releases) به جای `engage.cloudflareclient.com` باید IP اسکن شده بزارید چون این ادرس فیلتر شده است.
![Screenshot_2024-05-30-02-45-10-550_com termux](https://github.com/mansor427/IpScanner/assets/104245967/ea45fa57-01e9-4421-afde-e412b5c34c29)
